...
GGML_API void quantize_row_q8_a8_ref(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_q8_a8(const block_q8_a8 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
